...
<div id="listing_items">
            ...
            <td align="center"><?php echo $requestcount;?></td>
                ...
                <td>
                    <div class="mycp_listing_option">
                        <button class="btn btn-success" type="button" onclick="location.href='<?php echo $base_url;?>RequestParts/edit/<?php echo $request_id;?>/<?php echo $parts_id;?>'"><?php echo EDIT;?></button>
                    </div>
                    <div class="mycp_listing_option">
                        <button class="btn btn-primary" type="button"><?php echo VIEWAPPLICATION;?></button>
                    </div>
                    <div class="mycp_listing_option">
         <button class="btn btn-warning" type="button" onclick="location.href='<?php echo $base_url;?>RequestParts/activestatus/<?php echo $request_id.'/'.$parts_id;?>'">restabili</button>
                    </div>
                </td>
            </tr>
            <?php
  ...
  <?php }else{?>
<div class="tabdata">
                <p><?php echo REQUESTINACTIVEPART;?></p>
                <strong><?php echo NOREQUESTINACTIVE;?></strong>
            </div>
<?php }?>