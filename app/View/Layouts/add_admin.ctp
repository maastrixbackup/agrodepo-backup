                    ...
                    <ol class="breadcrumb">
						...
						$controller=$this->request->params['controller'];
							...
							switch($controller){
								...
								case "AdminUsers":
									?>
									 <li class="active"><a href="<?php echo $base_url;?>admin/AdminUsers/">Manage Admin</a></li>
								...
								case "AdminLangs":
									?>
									 <li class="active"><a href="<?php echo $base_url;?>admin/AdminLangs/">Manage Languages</a></li>					
                                      <li class="active">Add Languages</li>
									<?php
									break;
								case "AdminPages":
									?>
								...
								case "Banners":
									?>
									 <li class="active"><a href="<?php echo $base_url;?>admin/Banners/">Manage Banner</a></li>					
								...
								case "UserMemberships":
									?>
									 <li class="active"><a href="<?php echo $base_url;?>admin/UserMemberships/">Manage Memberships</a></li>					
                                      <li class="active">Add Memberships</li>
									<?php
									break;
								case "Advertisements":
									?>
								...
								case "SocialIcons":
									?>
									 <li class="active"><a href="<?php echo $base_url;?>admin/SocialIcons/">Manage Social Icons</a></li>					
                                      <li class="active">Add Social Icons</li>
									<?php
									break;
								}
						?>
                        <!--<li><a href="<?php echo $base_url;?>admin/AdminUsers/">Manage Users</a></li>
                        <li class="active">Add Users</li>-->
                    </ol>
                </section>
