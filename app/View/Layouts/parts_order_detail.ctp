...
?>
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="first"> <a style="z-index:9;" href="<?php echo $base_url;?>RequestParts/bidding"><span></span><?php echo BIDDING;?></a> </li>
            <li class="last"><a style="z-index:7;" href="javascript:void(0);">Detaliu de livrare</a></li>
          </ul>
            </div>
