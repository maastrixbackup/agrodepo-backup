...
function replyQuestion(replyid,advid,srlno)
{
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="first"> <a style="z-index:9;" href="<?php echo $base_url;?>pages/ask-question"><span></span><?php echo ASKQUESTION;?></a> </li>
            <li class="first"> <a style="z-index:9;" href="<?php echo $base_url;?>pages/sent-question"><span></span><?php echo SENTQUESTION;?></a> </li>
            <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo VIEWREPLY;?></a></li>
          </ul>
            </div>
        <div class="clearfix" style="height:10px;"></div>
        <h2 class="detailstitle1" style="color:#DF5E08">
        	<?php echo SENTQUESTION;?>
                    ...
                    ?>
                                    ...
                                    <div id="listing_items">
                                        <table cellpadding="0" cellspacing="0" class="tab-content">
                                          ...
                                          <td width="5%" align="left"><?php echo NRPOSTS;?></td>
                                          <td width="25%" align="left"><?php echo REPLIEDBY;?></td>
                                          <td width="25%" align="left"><?php echo REPLAY;?></td>
                                          <td width="10%" align="left"><?php echo POSTDATEE;?></td>
                                          </tr>
                                          <?php 
                                          $i=1;
										  ...
										  else
										  {
											  ?>
                                              <tr>
                                              <td colspan="7" style="text-align:center"><?php echo NOREPLAYFOUND;?></td>
                                              </tr>
                                              <?php
										  }
