...
?>
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo SENTQUESTION;?></a></li>
          </ul>
            </div>
                    ...
                    ?>
                                    ...
                                    <div id="listing_items">
                                        <table cellpadding="0" cellspacing="0" class="tab-content">
                                          ...
                                          <td width="25%" align="left"><?php echo QUESTION;?></td>
                                          <td width="10%" align="left"><?php echo DATE;?></td>
                                           <td width="10%" align="left"><?php echo VIEWREPLY;?></td>
                                          </tr>
                                          <?php 
                                          $i=1;
                                          ...
                                          foreach($SalesQuestion AS $SalesQuestionRes){
											...
											$questionurl=$base_url.'pages/view-ask-reply/'.$question['question_id'];
                                                ...
                                                <tr class="listing_data">
                                                   ...
                                                   <td valign="top">
                                                    ...
                                                    <td><a href="<?php echo $questionurl;?>" class="btn btn-success"><?php echo VIEWREPLY;?> </a>
                                                    </td>
                                                </tr>
