...
<script type="text/javascript">/* <![CDATA[ */
		...
		{				
				...
				parent.document.getElementById('postadDetailbtn').style.display = "block";
...
<body>
<?php echo $this->Form->create('PostAd', array('type' => 'file', 'action' => 'fileupload/', 'name' => 'fileuploadform')); ?>

<?php echo $this->Form->input('adv_img', array('type' => 'file','name' => 'data[PostAd][adv_img][]', 'label' => false,'class' => 'imgup', 'div' => false,'multiple' => 'multiple'));
