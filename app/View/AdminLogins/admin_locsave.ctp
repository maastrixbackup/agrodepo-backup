            ...
            <?php echo $this->Form->create('MasterLocation', array('type' => 'file')); ?>
                <div class="box-body">
                 <?php echo $this->Form->input('country_id',array('label'=>'Select County','type'=>'select', 'class' => 'form-control', 'div' => 'form-group', 'options' => $countyList, 'required' => 'required'));?>
 				 <?php echo $this->Form->input('location_name',array('label' => 'Locations','type' => 'textarea','class' => 'form-control', 'required' => 'required', 'div' => 'form-group'));?>
                 
            <div><i>multiple location add using separator(,)</i></div>
                </div><!-- /.box-body -->
