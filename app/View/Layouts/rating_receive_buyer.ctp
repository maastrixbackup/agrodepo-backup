 ...
 <div class="container">
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo RATINGRECIVEDBUYER;?></a></li>
          </ul>
            </div>
        <div class="clearfix" style="height:10px;"></div>
        <h2 class="detailstitle1" style="color:#DF5E08">
        	<?php echo RATINGRECIVEDBUYER;?>
...
<div id="listing_items">
  ...
  <?php }else{?>
                            <div class="tabdata">
                                            <strong><?php echo NOSALESRATINGRECIVED;?></strong>
                                        </div>
                            <?php }?>
