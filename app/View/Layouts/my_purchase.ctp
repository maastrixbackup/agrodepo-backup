 ...
 <div class="container">
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo MYPURCHASE;?></a></li>
          </ul>
            </div>
            ...
            <div class="row">
            	<div class="listtop34  not_fix">
					...
					<div id="listing_items">
						<table cellpadding="0" cellspacing="0" class="tab-content">
							<tbody>
								...
								<td align="center"><?php echo $requestcount;?></td>
									...
									<td align="center" class="sales_clerk" style="position:relative;">
										...
										<div class="clearfix"></div>
										<span class="gbutton6 panel_box custom_popbox">
											<?php echo DETAILSSELLER;?>
										...
										<a href="<?php echo $base_url;?>pages/torate/seller/<?php echo $SalesOrdersRes['SalesOrder']['id'];?>" class="to_rate"><img src="<?php echo $base_url;?>images/feedback.gif" /> <?php echo TORATE;?></a>
					  ...
					  <?php }else{?>
                            <div class="tabdata">
                                            <strong>No sales Purchased.</strong>
                                        </div>
                            <?php }?>
