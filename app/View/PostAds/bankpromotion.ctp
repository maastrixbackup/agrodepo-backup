...
try
{
	...
	$objPmReqCard->orderId 				= md5($tempDetails['TempPromoteAd']['random_id']);
	...
	$objPmReqCard->confirmUrl 			= $base_url.'PostAds/failed';
	$objPmReqCard->returnUrl 			= $base_url.'PostAds/success';
	...
	$objPmReqCard->invoice->amount		= $tempDetails['TempPromoteAd']['total_price'];
	...
	$billingAddress->firstName		= $userDetail['MasterUser']['first_name'];
	$billingAddress->lastName		= $userDetail['MasterUser']['last_name'];
	...
	$billingAddress->address		= $userDetail['MasterUser']['other_add'];
	$billingAddress->email			= $userDetail['MasterUser']['email'];
	$billingAddress->mobilePhone	= $userDetail['MasterUser']['telephone1'];
	...
	$shippingAddress->firstName		= $userDetail['MasterUser']['first_name'];
	$shippingAddress->lastName		= $userDetail['MasterUser']['last_name'];
	...
	$shippingAddress->address		= $userDetail['MasterUser']['other_add'];
	$shippingAddress->email			= $userDetail['MasterUser']['email'];
	$shippingAddress->mobilePhone	= $userDetail['MasterUser']['telephone1'];
