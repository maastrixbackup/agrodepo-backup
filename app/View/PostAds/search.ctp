...
function searchTxt()
{
	...
	var blankchk=/\S/;
	var url="<?php echo $base_url;?>PostAds/search/";
...
<?php
$seeUser=$this->Session->read('User');
$catarr=array();
$subcatarr=array();
$brandarr=array();
$modelarr=array();
                	...
                	<form class="form-inline" autocomplete="off">
                    	<div>
                        	...
                        	<div class="form-group row">
                                ...
                                <input type="text" placeholder="<?php echo KEYWORD;?>" name="searchtxt" id="searchtxt" value="<?php echo $searchtxt;?>" class="form-control input">
                                <div class="keywrd_pop_top1" id="topSrc1"></div>
                              </div>
                              <input type="hidden" id="sessuserid" name="sessuserid" value="<?=$seeUser['user_id']?>"></input>
                        </div>
                        	...
                        	<div class="form-group row">
                                ...
                                <select name="sortby" id="sortby" class="form-control" onchange="return sortBy(this.value);">
                                        ...
                                        <option value="sort:created/direction:asc"<?php if($this->request->params['named']['sort']=='created' && $this->request->params['named']['direction']=='asc'){?> selected="selected"<?php }?>><?php echo DATEASSEND;?></option>
                                        <option value="sort:created/direction:desc"<?php if($this->request->params['named']['sort']=='created' && $this->request->params['named']['direction']=='desc'){?> selected="selected"<?php }?>><?php echo DATEDESEND;?></option>
                                        <option value="sort:modified/direction:asc"<?php if($this->request->params['named']['sort']=='modified' && $this->request->params['named']['direction']=='asc'){?> selected="selected"<?php }?>><?php echo UPDATEASC;?></option>
                                         <option value="sort:modified/direction:desc"<?php if($this->request->params['named']['sort']=='modified' && $this->request->params['named']['direction']=='desc'){?> selected="selected"<?php }?>><?php echo UPDATEDESC;?></option>
                                         <option value="sort:quantity/direction:asc"<?php if($this->request->params['named']['sort']=='quantity' && $this->request->params['named']['direction']=='asc'){?> selected="selected"<?php }?>><?php echo QUANTITYINCREASE;?></option>
                                         <option value="sort:quantity/direction:desc"<?php if($this->request->params['named']['sort']=='quantity' && $this->request->params['named']['direction']=='desc'){?> selected="selected"<?php }?>><?php echo QUANTITYDOWN;?></option>
                                         <option value="sort:price/direction:asc"<?php if($this->request->params['named']['sort']=='price' && $this->request->params['named']['direction']=='asc'){?> selected="selected"<?php }?>><?php echo PRICEASCEN;?></option>
                                         <option value="sort:price/direction:desc"<?php if($this->request->params['named']['sort']=='price' && $this->request->params['named']['direction']=='desc'){?> selected="selected"<?php }?>><?php echo PRICEDOWN;?></option>
                                         <?php
                                        }
                                        else
                                        {
                                        ...
                                        <option value="sort:modified/direction:asc"><?php echo UPDATEASC;?></option>
                                         ...
                                         <option value="sort:price/direction:asc"><?php echo PRICEDOWN;?></option>
                                        <?php
                                        }
                                        ?>
                        ...
                        <div>
                        	<div class="col-lg-4">
                                <div class="form-group row">
                                    <label><?php echo BRANDS;?> / <?php echo MODEL;?></label>
                        ...
                        <div class="bs-callout bs-callout-info" id="callout-helper-bg-specificity">
                        	<h4><?php echo ACTIVEFILTER;?>: <span class="addnbr"><?php
                                ...
                                <tr class="listing_data">
                                    ...
                                    <td>
                                        ...
                                        <div class="mycp_listing_option remove">
                                            <?php echo $this->Form->postLink(__(REMOVE), array('action' => 'delete', $postAd['PostAd']['adv_id']), null, __('Are you sure you want to remove # %s?', $postAd['PostAd']['adv_name'])); ?>
                                        </div>
                                        <!-- <div class="mycp_listing_option remove">
                                            <?php echo $this->Form->postLink(__('Remove'), array('action' => 'delete', $postAd['PostAd']['adv_id']), null, __('Are you sure you want to remove # %s?', $postAd['PostAd']['adv_name'])); ?>
                                        </div> -->
                                        <div class="mycp_listing_option">
                                            <button class="btn btn-primary" type="button"><?php echo PROMOTE;?></button>
                                        </div>
                                    </td>
                                </tr>
                                <?php
