...
function replyQuestion(replyid,advid,srlno)
{
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo INBOX;?></a></li>
          </ul>
            </div>
                                          ...
                                          foreach($msgRes AS $msgResult){
											...
											$userdetail=$this->Custom->BapUserDetails($message['from_user']);
                                                ...
                                                <tr class="listing_data">
                                                    ...
                                                    <td><a href="<?php echo $base_url;?>pages/compose-message/replyid:<?php echo $message['from_user'];?>/msgid:<?php echo $message['msg_id'];?>" class="btn btn-success"> <?php echo REPLAY;?> </a> &nbsp;<a href="<?php echo $base_url;?>pages/delete-msg/msgid:<?php echo $message['msg_id'];?>" class="btn btn-success"> <?php echo DELETE;?> </a>
                                                      </td>
                                                </tr>
