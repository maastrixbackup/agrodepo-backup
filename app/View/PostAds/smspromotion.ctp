...
try
{
	...
	$objPmReqSms->returnUrl 	= $base_url.'PostAds/failed'; //sau $objPmReqSms->returnUrl = '<new return url>';
	$objPmReqSms->confirmUrl 	= $base_url.'PostAds/success'; //sau $objPmReqSms->confirmUrl = '<new confirm url>';
