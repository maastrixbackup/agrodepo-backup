...
<div class="row">
    ...
    <div class="col-md-6">
		...
		echo $this->Form->input('pass',array('type'=>'password','label' => 'Password','div' => 'form-group', 'class' => 'form-control'));
		echo $this->Form->input('confirm_password',array('type'=>'password','id'=>'rpwd','required'=>'required','onclick'=>'match_pass()','div' => 'form-group', 'class' => 'form-control'));
		...
		echo $this->Form->input('country_id',array('label' => 'District','type' => 'select','options' => @$country,'empty'=>'-- Choose County --','onChange'=>'location_list(this.value)','div' => 'form-group', 'class' => 'form-control'));
		echo $this->Form->input('locality_id',array('label' => 'City','div' => 'form-group', 'class' => 'form-control','type' => 'select','empty'=>'-- Choose Town --','id'=>'old_location','required'=>false));
		...
		echo $this->Form->input('is_active',array('type'=>'select','options'=>@$status,'label' => 'Status','div' => 'form-group', 'class' => 'form-control'));
	?>
