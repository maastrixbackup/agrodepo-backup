							...
							<div class="block-heading">
								  ...
								  ?>
                                    <ul class="filter_list <?php if(!empty($catdetails)){echo "expand_all";}else{ echo "expand_normal";}?>" id="cat_list">
                                        ...
                                        <li class="fl_item fl_item_visible">
                                           <label>
                                                <input type="checkbox" id="catlist<?php echo $leftcatres['SalesCategory']['category_id'];?>" class="camch catmatch" onClick="categoryList(<?php echo $leftcatres['SalesCategory']['category_id'];?>)"<?php if($paramcat==$fetchcat){?> checked="checked"<?php }?> value="<?php if($leftcatres['SalesCategory']['slug']!=''){echo $leftcatres['SalesCategory']['slug'];}else{echo $leftcatres['SalesCategory']['category_id'];}?>">
                                                         ...
                                                         <ul class="filter_list">
															...
															foreach($subcatlist as $subcatres)
															{
																...
																?>
                                                                 <li class="fl_item">
                                                               <label>
                                                                    <input type="checkbox" id="subcatlist<?php echo $subcatres['SalesCategory']['category_id'];?>" class="camch catmatch" onClick="subCategoryList(<?php echo $subcatres['SalesCategory']['category_id'];?>)"<?php if($paramcat==$fetchsubcat){?> checked="checked"<?php }?> value="<?php if($subcatres['SalesCategory']['slug']!=''){echo $subcatres['SalesCategory']['slug'];}else{echo $subcatres['SalesCategory']['category_id'];}?>">
								...
								?>
									...
									?>
                                        <li class="fl_item fl_item_visible">
                                            <label>
                                                <input type="checkbox" id="brand<?php echo $brandid;?>" class="camch brandmatch" onClick="brandList(<?php echo $brandid;?>)"<?php if($param_brand==$brandid){?> checked="checked"<?php }?> value="<?php if($brandSlug!=''){echo $brandSlug;}else{echo $brandid;}?>">
												...
												if(!empty($modellist))
												{
													...
													foreach($modellist as $modelres)
													{
														...
														?>
                                                         <li class="fl_item">
                                                        <label>
                                                            <input type="checkbox" id="model<?php echo $modelid;?>" class="camch brandmatch" onClick="modelList(<?php echo $modelid;?>)"<?php if($param_brand==$modelid){?> checked="checked"<?php }?> value="<?php if($modelSlug!=''){echo $modelSlug;}else{echo $modelid;}?>">
                                ...
                                <ul class="filter_price" style="width:95%;padding-left:15px;">
                                  ...
                                  <div id="slider-range"></div><div style="padding-top:10px; text-align:right;"><input type="button" onClick="priceList();" value=
                                  "<?php echo CONTIN;?>"></div>
								...
								?>
                                    <ul class="filter_list <?php if(!empty($county)){echo "expand_all";}else{ echo "expand_normal";}?>" id="city_list">
                                        ...
                                        <li class="fl_item fl_item_visible">
                                             <label>
                                                <input type="checkbox" id="county<?php echo $contryid;?>" class="camch countymatch" onClick="countyList(<?php echo $contryid;?>)"<?php if($county == $contryid){?> checked="checked"<?php }?> value="<?php echo $contryid;?>">
                                ...
                                <ul class="filter_text">
									...
									?>
                                        ...
                                        <font>
                                            <input type="button" class="submit" value="<?php echo SEARCH;?>" onClick="sellerList();">
                                        </font>
                                    </li>
                                </ul>
