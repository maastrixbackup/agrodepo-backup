...
<?php 
echo $this->Form->create('RequestPart', array('type' => 'file', 'action' => 'fileupload/seqno:'.$this->request->params['named']['seqno'], 'name' => 'fileuploadform', 'class' => 'formclas')); ?>
<ul class="file_select">
    <li>
        <a href="#">
            <span>+</span>
            <?php echo $this->Form->input('part_img', array('type' => 'file','name' => 'data[RequestPart][part_img][]', 'label' => false,'class' => 'imgup', 'div' => false));
 ?>
        </a>
    </li>
</ul>
