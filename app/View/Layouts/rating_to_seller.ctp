 ...
 <div class="container">
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="first"> <a style="z-index:9;" href="<?php echo $base_url;?>pages/rating-given-seller"><span></span> Rating For seller</a> </li>
        ...
        <div class="col-lg-12">
            ...
            <form action="" method="post" name="ratingform" id="ratingform" onsubmit="return ratingvalidate();">
                ...
                <div class="col-lg-2 col-sm-2 col-xs-4 rates rating_user">
                <div class="row">
