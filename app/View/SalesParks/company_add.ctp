...
<?php echo $this->Form->create('SalesPark', array('class' => 'form-inline', 'type' => 'file')); ?>
                    ...
                    <?php // echo $this->Form->input('location_id', array('label' => LOCALITY.'*', 'class' => 'form-control', 'options' => array('' => CHOOSECITY), 'div' => 'form-group row'));?>
                  ...
                  <?php echo $this->Form->input('other_add', array('label' => OTHERDETAILADDRESS, 'class' => 'form-control', 'placeholder' => ENTEROTHERDETAILS, 'div' => 'form-group row' , 'cols' => false, 'rows' => false));?>
                       ...
                       <div class="clear10"></div><div class="clear10"></div>
                        <div class="bs-callout bs-callout-info" id="callout-helper-bg-specificity">
                               <h5 class="paddingh4 text-upper op7"><?php echo DESCRIPTIONANDLOGO;?></h5>
                            </div>
                            <div class="clear5"></div>
                       ...
                       <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                               ...
                               <?php echo $this->Form->input('logo', array('label' =>LOGO.'/'.COMPANYBANNER, 'type' => 'file', 'class' => 'form-control',  'div' => 'form-group row'));?>
                        </div>
                       <div class="clear10"></div>
                        <div class="col-lg-6">
                      ...
                      <div class="clear10"></div><div class="clear10"></div>
                            ...
                            <?php if(!empty($brandList)){
								...
								?>                            
                                  <div class="col-lg-2">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="data[SalesPark][brand_id][]" value="<?php echo $brandid;?>"><?php echo $brandname;?>
                                        </label>
                                    </div>
                                  </div>
                                  <?php 
                        ...
                        <div class="col-lg-12">
                        	  <div class="form-group row">
                                ...
                                <input type="radio" name="data[SalesPark][contact_person]" value="1"> <span class="pull-left"><?php echo YES;?> &nbsp; &nbsp; &nbsp;</span>  <input type="radio"  name="data[SalesPark][contact_person]" value="0"> <span class="pull-left"> <?php echo NO;?> </span>
                              </div>
                        </div>
