...
<script type="text/javascript">/* <![CDATA[ */
		...
		{				
				...
				if(imgcontent!='')
				{
				parent.document.getElementById('bidgallery').style.display = "block";
				parent.document.getElementById('bidgallery').innerHTML = imgcontent;
				}
		}
	/* ]]> */
	</script>
...
<?php echo $this->Form->create('BidTempFile', array('type' => 'file', 'name' => 'RequestPartsBidTempFileForm', 'class' => 'formclas')); ?>

<?php echo $this->Form->input('img_pth', array('type' => 'file','name' => 'data[BidTempFile][img_pth][]', 'label' => false,'class' => 'imgup', 'div' => false,'multiple' => 'multiple'));
 ?>
