...
?>
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo SENTMESSAGE;?></a></li>
          </ul>
            </div>
                    ...
                    ?>
                                    ...
                                    <div id="listing_items">
                                        <table cellpadding="0" cellspacing="0" class="tab-content">
                                          ...
                                          <td width="10%" align="left"><?php echo SENTTO;?></td>
                                          ...
                                          foreach($msgRes AS $msgResult){
											...
											$userdetail=$this->Custom->BapUserDetails($message['to_user']);
                                                ?>
