...
function replyQuestion(replyid,advid,srlno)
{
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="first"> <a style="z-index:9;" href="<?php echo $base_url;?>pages/my-question"><span></span><?php echo MYQUESTION;?></a> </li>
            <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo REPLYLIST;?></a></li>
          </ul>
            </div>
                                    ...
                                    <div id="listing_items">
                                        <table cellpadding="0" cellspacing="0" class="tab-content">
                                          ...
                                          <td width="10%" align="left"><?php echo DATE;?></td>
                                           <td width="10%" align="left"><?php echo REPLAY;?></td>
                                          </tr>
                                          <?php 
                                          $i=1;
                                          ...
                                          foreach($SalesQuestion AS $SalesQuestionRes){
											...
											$questionurl=$base_url.'pages/my-sent-question/'.$question['question_id'];
                                                ...
                                                <tr class="listing_data">
                                                   ...
                                                   <td valign="top">
                                                    ...
                                                    <a href="<?php echo $questionurl;?>" class="btn btn-primary"> <?php echo SENTQUESTION;?> </a></td>
                                                </tr>
