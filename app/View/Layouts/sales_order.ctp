...
$adv_userid = stripslashes($salesDetail['PostAd']['user_id']);
$warranty = stripslashes($salesDetail['PostAd']['warranty']);
if (!empty($userDetail)) {
    ...
    <div class="innerpanel">
      ...
      <div class="col-md-12">
        ...
        <div class="col-lg-12 prof bs-example order_listnew">
          ...
          <?php echo $this->Form->create('SalesOrder', array('class' => 'form-horizontal')); ?>
          <div class="col-lg-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-7"><label><?php echo $price; ?> <?php echo $currency; ?> x <?php echo $qty; ?> pcs.</label></div>
            </div>

            <div class="form-group">
              <label class="col-lg-5 control-label"><?php echo TOTAL; ?>: </label>
              <div class="col-lg-7"><label><?php if ($qty != '') {
                                              echo $price * $qty;
                                              echo ' ' . $currency;
                                            } ?> + delivery cost *</label></div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-7">
                ...
                <input type="hidden" name="adv_userid" value="<?php echo $adv_userid; ?>" />
                ...
                ?>
                <select name="data[SalesOrder][delivery_method]" id="SalesOrderDeliveryMethod" class="form-control">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-7"><label><?php if ($warranty != '') {
                                              echo $warranty;
                                            } else {
                                              echo "N/A";
                                            } ?></label></div>
