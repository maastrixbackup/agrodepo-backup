						  ...
						  foreach($bidOffer AS $bidofr){
							...
							//pr($bid);
								...
								<tr class="listing_data">
                                    ...
                                    <td align="center"> <?php echo $bid['warranty'];?></td>
							   ...
							   $status=array(0=>'Approved',1=>'Winning',2=>'Cancel');
								...
								if($bid['status']==1)
								{
									?>
                                    <br />
                                    <a href="<?php echo $base_url;?>RequestParts/deliverydetail/<?php echo $bid['bid_id'];?>" class="btn btn-success">View Delivery Details</a>
                                    <?php
								}
								?></td>
                                 <!--   <td>-->
