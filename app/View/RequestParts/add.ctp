...
if(isset($this->request->data['RequestAccessory']))
{
	...
	//$max_price=$requestdetail['max_price'];
	//$currency=$requestdetail['currency'];
}
else
{
	$piesename='';
						...
						<table cellpadding="0" cellspacing="0" style="width:100%;">
							<tr>
								...
								<td style="text-align: right;">
                                    ...
                                    <?php
									echo $this->Form->input('want_song', array('label' => false, 'required' => 'required', 'type' => 'select','options' => array('new' => 'Noua', 'used' => 'din dezmembrari', 'both' => 'Noua sau din dezmembrari'), 'div' => false, 'class' => 'form-control step3_droplis1', 'style' => 'width:65%!important;'));?>
								</td>
							</tr>
						</table>
					</div>
						...
						<tr>
							<td style="width:100%!important">
								<div class="listphoto">
									<ul>
                                    <li>
										<iframe src="<?php echo $base_url;?>RequestParts/fileupload/seqno:1" style="border: none; overflow: hidden;"></iframe>
                                        </li>
										<li>
											<iframe src="<?php echo $base_url;?>RequestParts/fileupload/seqno:2" style="border: none; overflow: hidden;"></iframe>
										</li>
										<li>
											<iframe src="<?php echo $base_url;?>RequestParts/fileupload/seqno:3" style="border: none; overflow: hidden;"></iframe>
										</li>
										<li>
											<iframe src="<?php echo $base_url;?>RequestParts/fileupload/seqno:4" style="border: none; overflow: hidden;"></iframe>
										</li>
										<li>
											<iframe src="<?php echo $base_url;?>RequestParts/fileupload/seqno:5" style="border: none; overflow: hidden;"></iframe>
										</li>
									</ul>
