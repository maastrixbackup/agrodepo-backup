    ...
    <div class="col-md-9">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Add Manage Sales</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
        ...
        <div class="col-lg-6">
           <?php
		echo $this->Form->input('sub_cat_id', array('label' => false, 'size' =>8,'type' => 'select','options' => array($subcatid=>$subcatname),'div' => 'item post_dropdown', 'class' => 'form-control','style' => 'display:none;'));
		?> 
        </div><!-- /.col-lg-6 -->
    </div>
	  ...
	  if(isset($this->request->data['ManageSale']['adv_brand']) && !empty($this->request->data['ManageSale']['adv_brand']))
		{
            ...
            <input type='text' class='dataloadclass form-control' name='data[ManageSale][adv_brand_id]' value='<?php echo $brandname;?>' >
             ...
             <div class="col-lg-4 col-sm-4">
            <input type='text' class='dataloadclass form-control' name='data[ManageSale][model_nm<?php echo $modelname;?>]' value='<?php echo $modelname;?>' class='modelclass' >
             </div>
             <div class="col-lg-4 col-sm-4">
		...
		else if(isset($this->request->data['ManageSale']['adv_brand_id'])&& !empty($this->request->data['ManageSale']['adv_brand_id']))
		{
			...
			if($this->request->data['ManageSale']['adv_brand_id']!='')
			{
                ...
                <div class="clearfix"></div>
				<div id='div<?php echo $brandindex;?>' class="row">
                <input type='hidden' name='data[ManageSale][adv_brand][]' value='<?php echo $singlebrand;?>' >
                <input type='hidden' name='data[ManageSale][adv_model][]' value="<?php echo $modelarr[$brandindex];?>" >
                 <div class="col-lg-4 col-sm-4">
                <input type='text' class='dataloadclass form-control' name='data[ManageSale][adv_brand_id]' value='<?php echo $brandname;?>'>
                </div>
                 <div class="col-lg-4 col-sm-4">
