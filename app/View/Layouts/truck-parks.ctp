					...
					<div class="col-md-12 prof">
                         ...
                         <div id="breadcrumb">
                              <ul class="crumbs">
                                ...
                                <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo TRUCKPARKS;?></a></li>
                           	 </ul>
           				 </div>

                        <div class="clearfix" style="height:10px;"></div>

                         <h2 class="detailstitle1" style="color:#DF5E08"><?php echo TRUCKPARKS;?></h2>
                                            ...
                                            <div class="col-lg-8">
                                            	<div class="datalistitem">
                                                    ...
                                                    <div class="sr_user_isseller" style="background:none; padding-left:0; height:auto;">
                                                    	<span class="text-upper"><?php echo DISMENTALBRAND;?>:</span>
                                            ...
                                            <div class="col-lg-2">
                                            	<div class="row">
                                                	<div class="sr_price mr_minus">
                                                    	<h3>
                                                        <?php if(!empty($memdetail)){if($memdetail['UserMembership']['plan_img']!=''){
                        ...
                        <?php /*?> <button class="org_btn btn radius-zero imagefull text-upper" onclick="location.href='<?php echo $base_url;?>SalesParks/add';"><img src="<?php echo $base_url;?>images/plus_white.png" width="25"><strong>  <?php echo ADDTOPARKTRUCK;?></strong></button><?php */?>
                          <!--<div class="clear15"></div>-->
                          <h2 class="detailstitle1" style="color: #fff;background: #1996E6;padding: 5px 5px 5px 10px;"><?php echo RECENTPARKSTRUCK;?></h2>
                         <?php
