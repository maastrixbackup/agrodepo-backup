        ...
        <?php if($this->request->params['controller'] =='ManageBrands' && $this->request->params['action'] =='admin_index'){}else{?>
...
<?php }?>
<?php if($this->request->params['controller']=='ManageBrands'){
	?>
	<script type="text/javascript">
    $(document).ready(function(e){
        if($("#ManageBrandFlag").val()==0){
            $("#ManageBrandImage").attr("required", "required");
        }
        $("#ManageBrandFlag").change(function(e){
        	//alert($(this).val())
            if($(this).val()==0){
               $("#ManageBrandImage").attr("required", "required");
           }else{
            $("#ManageBrandImage").removeAttr("required");
           }
        });
    });
</script>
