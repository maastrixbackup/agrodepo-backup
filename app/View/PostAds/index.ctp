                	...
                	<form class="form-inline" autocomplete="off">
                    	<div>
                        	...
                        	<div class="form-group row">
                                ...
                                <input type="text" placeholder="<?php echo KEYWORD;?>" name="searchtxt" id="searchtxt" class="form-control input">
                        ...
                        <table cellpadding="0" cellspacing="0" class="tab-content">
                            <tbody>
                                ...
                                <tr class="listing_data">
                                    ...
                                    <td align="center"><?php echo $this->Custom->totalView($postAd['PostAd']['adv_id']);?></td>
                                    ...
                                    <td>
                                        ...
                                        <div class="mycp_listing_option">
                                            <button class="btn btn-primary" type="button" <?php if($postAd['PostAd']['is_promote']==0){?>onclick="location.href='<?php echo $base_url;?>PostAds/promotion/<?php echo $postAd['PostAd']['adv_id'];?>';"<?php }else{?> onclick="alert('you have already promote this ad');"<?php }?>><?php echo PROMOTE;?></button>
                                        </div>
                                    </td>
                                </tr>
                                <?php
