...
?>
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo ACCOUNTCREADIT;?></a></li>
          </ul>
            </div>
        <div class="clearfix" style="height:10px;"></div>
        <h2 class="detailstitle1" style="color:#DF5E08">
        	<?php echo ACCOUNTCREADIT;?>
        ...
        <div class="col-lg-12">
                 ...
                 <div class="row">
                                <div class="listtop34">
                                    ...
                                    <div id="listing_items" class="col-lg-7">
                                        <table cellpadding="0" cellspacing="0" class="tab-content">
                                            <tbody>
                                               
                                                <tr class="listing_header">
                                          <td width="10%" align="center"><?php echo Sl;?></td>
                                          <td width="20%" align="left"><?php echo LASTTRANSATIONID;?></td>
                                          <td width="25%" align="left"><?php echo LASTMEMBERPLAN;?></td>
                                          <td width="25%" align="left"><?php echo TOTALCREDITS;?></td>
                                          ...
                                          foreach($historyRes AS $historyResult){
											 ...
											 $credit=$historyResult['UserCreditAccount']['credits'];
										  ...
										  else
										  {
											  ?>
                                              <tr>
                                              <td colspan="6" style="text-align:center"><?php echo NOCREDITFOUND;?></td>
                                              </tr>
                                              <?php
										  }
