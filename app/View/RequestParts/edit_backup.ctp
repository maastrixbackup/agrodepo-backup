 ...
 ?>
  ...
  <div class="row"> 
                     <div class="form-group">
                        <label class="col-lg-5 control-label">* <?php echo BRAND;?> </label>
                        <?php
      ...
      <p class="sip_head">2. <?php echo LOOKPARTOFACCESSO;?></p>
	    ...
	    if(isset($this->request->data['RequestAccessory']['name_piece'])){
		   if(is_array($this->request->data['RequestAccessory']['name_piece'])){
			   ...
			   foreach($this->request->data['RequestAccessory']['name_piece'] as $partindex => $singname)
			   {
				   ...
				   $part_id=$this->request->data['RequestAccessory']['part_id'];
		   ?>
           <div class="col-lg-6 form_rpt" id="section<?php echo $partcount;?>" >
                  <div class="row"> 
                      <div class="clear10"></div>
                      <div class="form-group">
                      <input type="hidden" name="data[RequestAccessory][temppart_id][]" value="<?php echo $part_id[$partindex];?>" />
                                  ...
                                  <div class="form-group">
									...
									<div class="col-lg-7">
                                   <?php echo $this->Form->input('max_price', array('label' => false, 'value' => $max_price[$partindex],'name' => 'data[RequestAccessory][max_price][]', 'div' => false, 'class' => 'form-control', 'style' => 'width:35%;float:left;margin-right:5px;','onkeyPress'=>'chkNumber(event)'));?>
									  &nbsp;
                                  ...
                                  <div class="form-group">
									<label class="col-lg-5 control-label"><?php echo PICTURES;?></label>
                                     ...
                                     <?php 
										$imggal=$this->requestAction('/RequestParts/originalImg/'.$part_id[$partindex]); 
										if($imggal!='')
										{
										 ?>
                                     <div id="updatepic"><?php echo $imggal;?></div>
                                     
                                     <?php }?>
								  </div>
       <div class="clear15"></div>
             <!-- <a href="javascript:void(0);" onclick="removePart(<?php //echo $partcount;?>)" class="pull-right" style="margin-right:10px;"> Remove <img src="<?php echo $base_url;?>images/delete_icon.png" /> </a>  
                  ...
                  <div class="row"> 
                      ...
                      <div class="form-group">
                                  ...
                                  <div class="form-group">
									<label class="col-lg-5 control-label"><?php echo MAXPRICE;?></label>
									<div class="col-lg-7">
                                   <?php echo $this->Form->input('max_price', array('label' => false,'name' => 'data[RequestAccessory][max_price][]', 'div' => false, 'class' => 'form-control', 'style' => 'width:35%;float:left;margin-right:5px;'));?>
									  &nbsp;
       ...
       <?php }?>
         ...
         <div class="clear10"></div>
              <!--<a href="javascript:void(0);" onclick="appenPart();"> Add another piece <img src="<?php //echo $base_url;?>images/plus.jpg" />  </a>  -->
  ...
  <div class="row"> 
      <div class="clear10"></div>
       ...
       <div class="clear40"></div>
      <p class="sip_head">4. <?php echo WHEREWANTTOSHIPED;?>?</p>
  ...
  <div class="row"> 
      ...
      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        {
                            echo $this->Form->input('city', array('label' => false, 'type' => 'select','options' => array('' => '-Choose City-'), 'div' => 'col-lg-7', 'class' => 'form-control'));
                        }
                    ?>
                      </div>
      ...
      <div class="clear10"></div>
      <div class="carry col-lg-6"><input type="submit" name="Submit2" value="Update Request" class="newsletter_snd_btn"></div>
