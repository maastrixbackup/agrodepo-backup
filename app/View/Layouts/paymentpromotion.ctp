   ...
   //$(".owl-carousel").html("loading....");
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="first"> <a style="z-index:9;" href="<?php echo $base_url;?>PostAds/"><span></span>Post ads</a> </li>
            <li class="last"><a style="z-index:7;" href="javascript:void(0);">Promovare anunt</a></li>
          </ul>
            </div>
