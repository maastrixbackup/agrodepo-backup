...
function removedata(imgid,img_fold)
{
	$.ajax(
			{
				type: 'POST',
				url: '<?php echo $base_url; ?>PostAds/removeimg',
...
function getrotateidFunc(imgid,imgFrom){
	$("#iframeid").attr("src", "<?php echo $base_url;?>PostAds/rotateimg/"+imgid+"/"+imgFrom);
	//alert(imgid);
}
function closeRotation(){
	$("#fileuplodframe").attr('src', '<?php echo $base_url;?>PostAds/fileupload/<?php echo $this->request->data['PostAd']['adv_id'];?>');
}
</script>
<style>
	.fl{float:left;}
...
<?php echo $this->Form->create('PostAd', array('type' => 'file')); ?>
   ...
   <!-- <input type="text" name="" value="" maxlength="150" class="">-->
     ...
     <?php
      ...
      <div class="clear"></div>
    <iframe src="<?php echo $base_url;?>PostAds/fileupload/<?php echo $this->request->data['PostAd']['adv_id'];?>" style="width:620px;height:35px;border: none;" id="fileuplodframe"></iframe>
...
<div id="picGallery" class="iframe_PostAd" style="display:none;"></div>
  ...
  <div class="cf_item cfi_type_pulldown cfi_id_3">
    ...
    <?php echo $this->Form->input('product_cond', array('label' => false,'type' => 'select','options' => array('' => SELECT,'new'=>'nou', 'Used' => 'utilizare')));?>
  </div>
      ...
      <?php /*?>  <div class="col-lg-1" style="text-align:center;">
        ...
        <div class="col-lg-6">
            ...
            <div class="col-lg-12 col-sm-12 col-xs-12" style="min-height:32px;">
                                <div class="row" id="postadDetailbtn">
                                <input type="submit" name="Submit2"  value="Continua cu Descrierea &raquo;" id="prdbtn" class="blue_btn">
                                </div>
                                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <iframe src="<?php echo $base_url;?>PostAds/rotateimg/" width="560" height="441" frameborder="0" allowtransparency="true" id="iframeid"></iframe>  
      </div>
