 ...
 <div class="container">
    ...
    <div class="innerpanel"> 
        ...
        <div id="breadcrumb">
            ...
            <li class="last"><a style="z-index:7;" href="javascript:void(0);"><?php echo RATINGFORBUYER;?></a></li>
          </ul>
            </div>
        <div class="clearfix" style="height:10px;"></div>
        <h2 class="detailstitle1" style="color:#DF5E08">
        	<?php echo RATINGFORBUYER;?>
...
<div id="listing_items">
              ...
              <div class="modal-dialog order_modal3">
                <div class="modal-content">
                  ...
                  <div class="modal-body order_listscroll2">
                	...
                	<a href="<?php echo $base_url;?>pages/buyer-torate/buyer/<?php echo $SalesOrdersRes['SalesOrder']['id'];?>" class="to_rate"><img src="<?php echo $base_url;?>images/feedback.gif" /><?php echo TORATE;?></a>
  ...
  <?php }else{?>
                            <div class="tabdata">
                                            <strong><?php echo NOSALESRATINGGIVEN;?></strong>
                                        </div>
                            <?php }?>
