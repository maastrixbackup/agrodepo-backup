<script>           
function replyQuestion(replyid,userid,bidid,partsid,requestid)
{
	if(replyid!='')
	{
		$("#showquestion").show();
...
?>
        ...
        <div id="listing_items">
            <table cellpadding="0" cellspacing="0" class="tab-content">
              ...
              <td width="10%" align="left">trimis de</td>
				...
				else
				{
                    ...
                    <tr class="listing_data">
                       ...
                       <?php if(!empty($userdetail)){?><a href="<?php echo $base_url;?>pages/user-profiles/<?php echo $userdetail['MasterUser']['user_id'];?>" target="_blank"><?php echo $userdetail['MasterUser']['first_name'].' '.$userdetail['MasterUser']['last_name'];?></a><?php }?>
                        ...
                        <td valign="top"><a href="#" class="btn btn-success" onclick="replyQuestion(<?php echo $question['qid'];?>,<?php echo $question['user_id'];?>,<?php echo $question['bidid'];?>,<?php echo $question['parts_id'];?>,<?php echo $question['request_id'];?>);"> <?php echo REPLAY;?> </a></td>
                    </tr>
