                    ...
                    <div id="listing_items">
                        <table cellpadding="0" cellspacing="0" class="tab-content">
                          ...
                          <td width="7%" align="left">Comanda ID</td>
                           <td width="14%" align="left">Piese de cerere</td>
                          <td width="12%" align="left">ofertant</td>
						  ...
						  foreach($partsOrders as $partsOrdersRes):
							...
							//pr($bid);
								...
								<tr class="listing_data">
                                    ...
                                    <td valign="top">
                                       <?php $partsdetail=$this->Custom->BapCustUniPartsDetail($partsOrder['parts_id']);
							   ...
							   $status=array(0=>'Confirmed Order');
                                ...
                                <td align="center"><?php echo date("d-m-Y", strtotime($partsOrder['created']));?></td>
                                  <td><a href="javascript:void(0);" class="btn btn-success"  data-toggle="modal" data-target="#parts_order<?php echo $ordercount;?>">Vezi Detalii</a>
                                  <div class="modal fade" id="parts_order<?php echo $ordercount;?>">
              <div class="modal-dialog order_modal3">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Piese de schimb Comanda</h4>
                  </div>
