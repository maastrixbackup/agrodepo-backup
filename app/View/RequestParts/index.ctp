...
<div id="listing_items">
    <table cellpadding="0" cellspacing="0" class="tab-content">
        <tbody>
         ...
         <button class="btn btn-primary" type="button" onclick="location.href='<?php echo $base_url;?>pages/request-parts/<?php echo $slug_nm;?>'"><?php echo VIEWAPPLICATION;?></button>
                     ...
                     <div class="mycp_listing_option">
         <button class="btn btn-danger" type="button" onclick="location.href='<?php echo $base_url;?>RequestParts/cancel/<?php echo $request_id.'/'.$parts_id;?>'">anulează</button>
                    </div>
                   <?php /*?> <div class="mycp_listing_option">
                        <button class="btn btn-success" type="button" onclick="location.href='<?php echo $base_url;?>RequestParts/request_response/<?php echo $request_id.'/'.$parts_id;?>'"><?php echo VIEWRESPONSE;?></button>
                    </div><?php */?>
                </td>
            </tr>
            <?php
  ...
  <?php }else{?>
<div class="tabdata">
                <p><?php echo REQUESTCURENTACTIVE;?></p>
                <strong><?php echo NOREQUESTHAVEACTIVE;?></strong>
            </div>
<?php }?>