                                ...
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <div class="input-group">
                                            <input type="text"  placeholder="Search Banner" name="searchtxt" id="searchtxt" class="form-control input-sm pull-right bannerinput" style="width: 150px;"/>
			...
			<th class="actions" style="width:10%"><?php echo __('Actions'); ?></th>
                                        ...
                                        <tr>
                                            <td><?php echo $bannercount; ?>&nbsp;</td>
												<?php
                                                    $banner_img= $banner['Banner']['banner_img'];
                                                    $path ='files/banner/80X80_'.$banner_img;
                                                    if (file_exists($path)) {
                                                    $banner_img_path = $base_url.'files/banner/80X80_'.$banner_img;
                                                    }else{
                                                    $banner_img_path = $base_url.'files/banner/'.$banner_img;
                                                    }
                                                ?>
                                            <td><img src="<?php echo $banner_img_path;?>" style="width:80px; height:80px" alt="<?php echo h($banner['Banner']['banner_title']); ?>" /> &nbsp;</td>
                                             <td><a href="<?php echo $base_url;?>admin/Banners/view/<?php echo $banner['Banner']['banner_id'];?>"><?php echo h($banner['Banner']['banner_title']); ?></a>&nbsp;</td>
