...
<div id="listing_items">
        ...
        <tbody>
            ...
            <td align="center"><?php echo $requestcount;?></td>
                ...
                <td>
                    ...
                    <div class="mycp_listing_option">
                        <button class="btn btn-danger" type="button" onclick="location.href='<?php echo $base_url;?>pages/request-parts/<?php echo $slug_nm;?>'"><?php echo VIEWAPPLICATION;?></button>
                    </div>
                </td>
            </tr>
            <?php
  ...
  <?php }else{?>
<div class="tabdata">
                <p><?php echo REQUSTWINNINGS;?></p>
                <strong><?php echo NOREQUESTWINNINGS;?></strong>
            </div>
<?php }?>